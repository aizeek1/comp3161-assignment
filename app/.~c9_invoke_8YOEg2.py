...
def register():
    if request.method == 'POST':
        ...
        p = """ INSERT INTO patients (patientID,patient_lname,patient_fname,gender,) VALUES ()"""
        phone=request.form['phone']
        p
        p = """ INSERT INTO patients (patientID,patient_lname,patient_fname,gender,patient_dob) VALUES ()"""
